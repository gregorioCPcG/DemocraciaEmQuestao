...
apoio_predic_modelo532_toleraPL <- plot_predictions(modelo532_toleraPL, condition=c("FeelingNumericPT")) + theme_bw()+labs(x="Sentimento partidário PL",
                                                                                                                           y= "Apoio aos princípios")
apoio_predic_modelo532_toleraPL

apoio_predic_modelo532_toleraPT <- plot_predictions(modelo532_toleraPT, condition=c("FeelingNumericPL")) + theme_bw()+labs(x="Sentimento partidário PT",
                                                                                               y= "Apoio aos princípios")
